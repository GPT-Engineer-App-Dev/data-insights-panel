    ...
    <Container maxW="container.xl" py={10}>
      <VStack spacing={10}>
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={10} width="100%">
          <StatBox icon={FaDollarSign} title="Revenue" value="$50,000" change="+5%" />
          <StatBox icon={FaChartLine} title="Sales" value="1,200" change="-2%" />
          <StatBox icon={FaUsers} title="Customers" value="300" change="+10%" />
          <StatBox icon={FaShoppingCart} title="Orders" value="150" change="+3%" />
        </SimpleGrid>
      </VStack>
    </Container>
  );
...
const StatBox = ({ icon, title, value, change }) => {
